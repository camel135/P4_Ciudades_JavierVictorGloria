...
object FuenteDatos {
    ...
    val lugares = listOf(
        ...
        Lugar(
            R.string.casas_cubo,
            ciudades[0],
            R.drawable.img_casas_cubo,
            R.string.desc_casas_cubo
        ),
        Lugar(
            R.string.puente_erasmo,
            ciudades[0],
            R.drawable.img_puente_erasmo,
            R.string.desc_puente_erasmo
        ),
        ...
        Lugar(
            R.string.plaza_alta,
            ciudades[1],
            R.drawable.img_plaza_alta,
            R.string.desc_plaza_alta
        ),
        ...
        // --- ORÁN (ciudades[2]) ---
        Lugar(
            R.string.fuerte_santa_cruz,
            ciudades[2],
            R.drawable.img_santa_cruz,
            R.string.desc_santa_cruz
        ),
        Lugar(
            R.string.mezquita_pasha,
            ciudades[2],
            R.drawable.img_mezquita,
            R.string.desc_mezquita
        ),
        Lugar(R.string.catedral_oran, ciudades[2], R.drawable.img_catedral, R.string.desc_catedral),
        Lugar(
            R.string.front_de_mer,
            ciudades[2],
            R.drawable.img_front_mer,
            R.string.desc_front_mer
        ),
        Lugar(
            R.string.palacio_bey,
            ciudades[2],
            R.drawable.img_palacio_bey,
            R.string.desc_palacio_bey
        ),
        ...
        Lugar(
            R.string.museo_cafe,
            ciudades[3],
            R.drawable.img_museo_cafe,
            R.string.desc_museo_cafe
        ),
        Lugar(
            R.string.jardin_playa,
            ciudades[3],
            R.drawable.img_jardin_santos,
            R.string.desc_jardin_santos
        ),
        Lugar(
            R.string.monte_serrat,
            ciudades[3],
            R.drawable.img_monte_serrat,
            R.string.desc_monte_serrat
        ),
        Lugar(
            R.string.estadio_santos,
            ciudades[3],
            R.drawable.img_vila_belmiro,
            R.string.desc_estadio
        ),
        Lugar(R.string.acuario_santos, ciudades[3], R.drawable.img_acuario, R.string.desc_acuario),

        // --- HONG KONG (ciudades[4]) ---
        Lugar(
            R.string.victoria_peak,
            ciudades[4],
            R.drawable.img_victoria_peak,
            R.string.desc_victoria_peak
        ),
        ...
        Lugar(
            R.string.temple_street,
            ciudades[4],
            R.drawable.img_temple_market,
            R.string.desc_temple
        ),
        Lugar(
            R.string.avenue_stars,
            ciudades[4],
            R.drawable.img_avenue_stars,
            R.string.desc_avenue_stars
        )
    )
}
 **/