...
object FuenteDatos {
    ...
    val lugares = listOf(
        ...
        Lugar(R.string.markthal, ciudades[0], R.drawable.img_markthal, R.string.desc_markthal, R.string.restaurantes),
        ...
        Lugar(R.string.plaza_alta, ciudades[1], R.drawable.img_plaza_alta, R.string.desc_plaza_alta, R.string.centros_comerciales),
        Lugar(R.string.parque_cristina, ciudades[1], R.drawable.img_parque, R.string.desc_parque, R.string.parques),
        Lugar(R.string.puerto_algeciras, ciudades[1], R.drawable.img_puerto, R.string.desc_puerto, R.string.centros_comerciales),
        Lugar(R.string.mercado_abastos, ciudades[1], R.drawable.img_mercado, R.string.desc_mercado, R.string.restaurantes),

        // --- ORÁN (ciudades[2]) ---
        Lugar(R.string.fuerte_santa_cruz, ciudades[2], R.drawable.img_santa_cruz, R.string.desc_santa_cruz, R.string.parques),
        Lugar(R.string.mezquita_pasha, ciudades[2], R.drawable.img_mezquita, R.string.desc_mezquita, R.string.parques),
        Lugar(R.string.catedral_oran, ciudades[2], R.drawable.img_catedral, R.string.desc_catedral, R.string.centros_comerciales),
        Lugar(R.string.front_de_mer, ciudades[2], R.drawable.img_front_mer, R.string.desc_front_mer, R.string.cafeterias),
        Lugar(R.string.palacio_bey, ciudades[2], R.drawable.img_palacio_bey, R.string.desc_palacio_bey, R.string.restaurantes),

        // --- SANTOS (ciudades[3]) ---
        Lugar(R.string.museo_cafe, ciudades[3], R.drawable.img_museo_cafe, R.string.desc_museo_cafe, R.string.cafeterias),
        Lugar(R.string.jardin_playa, ciudades[3], R.drawable.img_jardin_santos, R.string.desc_jardin_santos, R.string.parques),
        Lugar(R.string.monte_serrat, ciudades[3], R.drawable.img_monte_serrat, R.string.desc_monte_serrat, R.string.cafeterias),
        Lugar(R.string.estadio_santos, ciudades[3], R.drawable.img_vila_belmiro, R.string.desc_estadio, R.string.centros_comerciales),
    ...
    val categoriasOpciones = listOf(
        Pair(0,R.drawable.outline_home_app_logo_24),
